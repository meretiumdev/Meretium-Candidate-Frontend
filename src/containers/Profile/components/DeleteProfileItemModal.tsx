...
interface DeleteProfileItemModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function DeleteProfileItemModal({
  isOpen,
  onClose,
  onConfirm,
  deleting = false,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-[18px] md:text-[20px] font-semibold text-[#101828] mb-2">{title}</h3>
        <p className="text-[#475467] text-[14px] leading-relaxed mb-8">{message}</p>
