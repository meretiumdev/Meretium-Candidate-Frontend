  ...
  return (
    <div className="flex items-center justify-between py-6 border-b border-gray-200 last:border-0 last:pb-0 font-manrope">
      ...
      <button 
        ...
        className={`w-11 h-6 rounded-full transition-colors relative duration-200 shrink-0 ${disabled ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'} ${checked ? 'bg-[#FF6934]' : 'bg-[#EAECF0]'}`}
      >
